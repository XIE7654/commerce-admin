<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="店铺类型：1-全托管，2-半托管，3-本土店铺" prop="shopType">
        <el-select v-model="formData.shopType" placeholder="请选择店铺类型：1-全托管，2-半托管，3-本土店铺">
...
const formRules = reactive({
  shopType: [{ required: true, message: '店铺类型：1-全托管，2-半托管，3-本土店铺不能为空', trigger: 'change' }],
