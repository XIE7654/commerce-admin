<template>
    ...
    >
      <el-form-item label="店铺类型：1-全托管，2-半托管，3-本土店铺" prop="shopType">
        <el-select
          ...
          placeholder="请选择店铺类型：1-全托管，2-半托管，3-本土店铺"
          clearable
          class="!w-240px"
        >
      ...
      <el-form-item label="Temu 授权 Token" prop="authToken">
        <el-input
          v-model="queryParams.authToken"
          placeholder="请输入Temu 授权 Token"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="店铺类型：1-全托管，2-半托管，3-本土店铺" align="center" prop="shopType" />
