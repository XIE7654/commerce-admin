<template>
    ...
    >
      ...
      <el-form-item label="Amazon 区域：NA、EU、FE" prop="region">
        <el-input
          ...
          placeholder="请输入Amazon 区域：NA、EU、FE"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="Amazon sellerId" align="center" prop="sellerId" />
      <el-table-column label="默认 marketplaceId" align="center" prop="marketplaceId" />
      <el-table-column label="店铺名称" align="center" prop="shopName" />
      <el-table-column label="Amazon 区域：NA、EU、FE" align="center" prop="region" />
      <el-table-column
        label="授权时间"
        align="center"
        prop="authorizeTime"
      ...
      <el-table-column
        label="授权过期时间"
        align="center"
        prop="authorizeExpireTime"
        :formatter="dateFormatter"
        width="180px"
      />
      <el-table-column
        label="广告 access token 过期时间"
        align="center"
        prop="adAccessTokenExpiresAt"
        :formatter="dateFormatter"
        width="180px"
      />
      <el-table-column
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, 'Amazon店铺授权.xls')
  } catch {
  } finally {
